HaonzhaoAdmin::Application.routes.draw do
  ...
  resources :hangzhou do
    collection do
      get :hz_record_result,:add_way_bill,:remove_way_bill,:view_way_bill,:add_order_info,:ws_test, :apply_personal_goods_form, :importorder, :personal_goods_declare, :taxindividual_product_applyisneed,:productapplication,:company_applied,:products,:orders,:personals
