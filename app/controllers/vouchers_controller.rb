class VouchersController < ApplicationController
  ...
  private
    ...
    def voucher_params
      params.require(:voucher).permit(:name, :type, :discount, :logged, :shipping, :total, :date_start, :date_end, :uses_total, :uses_customer, :integer, :status, :boolean, :date_added, :promotion_id)
    end
end
